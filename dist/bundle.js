...
;// CONCATENATED MODULE: ./src/components/Format.js
...
;// CONCATENATED MODULE: ./src/img/placeholderImg.png
const placeholderImg_namespaceObject = __webpack_require__.p + "4af9ce1c2fe92f787b96.png";
...
function Card(book) {
  ...
  const imageUrl = book.volumeInfo.imageLinks ? book.volumeInfo.imageLinks.thumbnail : placeholderImg_namespaceObject
  const id = book.id
...
;// CONCATENATED MODULE: ./src/components/Category.js
...
/* harmony default export */ const Slider = ((/* unused pure expression or super */ null && (swiper)));
;// CONCATENATED MODULE: ./src/components/LoadMore.js
...
const src_activeCategory = categoriesData[0]

const categoryList = document.querySelector('.categories')
categoryList.insertAdjacentHTML('afterbegin', Category(categoriesData, src_activeCategory))
categoryListener(cart)

let startIndex = 0
let maxResults = 6

const url = `https://www.googleapis.com/books/v1/volumes?q="subject:${src_activeCategory}"&key=${CONFIG.key}&printType=books&startIndex=${startIndex}&maxResults=${maxResults}&langRestrict=en`
